...
import { SB_URL, TAG_RULES } from './config.js?v=20260409zg';
...
import { anthropicFetch } from './api.js?v=20260409zg';
import { openCompany, sortCompanies, boldKw, completeness, clog } from './hub.js?v=20260409zg';
