...
import { SB_URL, TAG_RULES } from './config.js?v=20260410d23';
...
import { anthropicFetch } from './api.js?v=20260410d23';
import { openCompany, sortCompanies, boldKw, completeness, clog } from './hub.js?v=20260410d23';
...
export function renderList(){
  ...
  scroll.innerHTML=filt.map(c=>{
    ...
    if(c.icp){const icpTier=c.icp>=8?'hi':c.icp>=6?'mid':'lo';details.push(`<span class="c-detail-item c-di-icp icp-score ${icpTier}">ICP ${c.icp}</span>`);}
