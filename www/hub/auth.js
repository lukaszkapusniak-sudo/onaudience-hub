...
import { enterDemoMode, isDemoMode } from './demo.js?v=20260410d22';
import { SB_URL, SB_KEY } from './config.js?v=20260410d22';
...
export async function getUserProfile(userId) {
  ...
  const res = await fetch(`${SB_URL}/rest/v1/user_profiles?id=eq.${userId}&select=*`, {
    headers: authHdr(),
  });
