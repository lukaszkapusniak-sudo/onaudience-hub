...
export const DEMO_COMPANIES = [
  {
    ...
    hq_city: 'Amsterdam',
    region: 'NL',
    website: 'https://byronics.example',
    size: '1001-5000',
    ...
    outreach_angle:
      "Byronics' first-party gaming audience — 300M+ players — is exactly the kind of deterministic signal onAudience segments activate across DSPs. A data partnership unlocks CTV extension for endemic advertisers without relying on third-party cookies.",
    relationship_status: 'Contacted',
    data_richness: 9,
    founded_year: 2014,
    funding: 'EUR 900M+',
    tech_stack: [
      { tool: 'Google Ad Manager', category: 'Ad Server' },
      { tool: 'Header Bidding Wrapper', category: 'Monetisation' },
      { tool: 'Internal CRM', category: 'CRM' },
    ],
  ...
  },
  {
    ...
    hq_city: 'Berlin',
    region: 'DE',
    website: 'https://kafkatech.example',
    size: '201-500',
    note: 'Enterprise CDP with strong EU telco data roots. TCF certified. Active in cookie-alternative space.',
    outreach_angle:
      "Kafkatech's CDP layer is the perfect activation surface for onAudience's segment taxonomy — their clients already want pre-built EU audience segments, we just need to be the plug-in data layer.",
    relationship_status: 'Meeting',
    data_richness: 10,
    founded_year: 2014,
    funding: '$120M',
    tcf_vendor_id: 301,
  ...
  },
  {
    ...
    hq_city: 'Hamburg',
    region: 'DE',
    website: 'https://verlaine-media.example',
    size: '201-500',
  ...
  },
  {
    ...
    hq_city: 'Barcelona',
    region: 'ES',
    website: 'https://pushkinstream.example',
    size: '51-200',
    note: 'European CTV streaming expert. AVOD and FAST channels. Data from 42M+ users across EU.',
    outreach_angle:
      "Pushkin Stream's AVOD audience is one of the richest first-party CTV signals in Europe. onAudience segments could power audience extension campaigns for their FAST channel partners without building the data infrastructure themselves.",
    relationship_status: 'Contacted',
    data_richness: 7,
    founded_year: 2012,
    dsps: 'TTD,Xandr',
  ...
  {
    id: 'addison-consent',
    name: 'Addison Consent',
    type: 'partner',
    icp: 5,
    category: 'Privacy & Consent',
    hq_city: 'New York',
    region: 'US',
    website: 'https://addisonconsent.example',
    size: '201-500',
  ...
  {
    id: 'neruda-analytics',
    name: 'Neruda Analytics',
    type: 'prospect',
    icp: 4,
    category: 'Audience Intelligence',
    hq_city: 'Amsterdam',
    region: 'NL',
    website: 'https://nerudaanalytics.example',
    size: '501-1000',
    note: 'Subscription and audience analytics platform for publishers. First-party data from 1,000+ news sites.',
    outreach_angle:
      "Neruda Analytics sits on an enormous reservoir of subscribed, consent-based reader data. Activating that through onAudience's DSP integrations is an obvious win for their publisher clients.",
    data_richness: 7,
    icp: 4,
    founded_year: 2012,
    relationship_status: 'No Contact',
  },
  {
    id: 'woolf-mobile',
    name: 'Woolf Mobile',
    ...
    hq_city: 'London',
    region: 'GB',
    website: 'https://woolfmobile.example',
    size: '201-500',
  ...
  },
  {
    ...
    region: 'US',
    website: 'https://dickenssupply.example',
    size: '1001-5000',
  ...
  {
    id: 'borges-identity',
    name: 'Borges Identity',
    type: 'prospect',
    icp: 5,
    category: 'Identity / Cookieless',
    hq_city: 'Paris',
    region: 'FR',
    website: 'https://borgesidentity.example',
    size: '51-200',
    note: 'Shared identity solution for publishers and the open web. 400M+ IDs across EU. TCF certified.',
    outreach_angle:
      'Borges Identity solves the identity layer — onAudience solves the audience data layer. A joint offering where onAudience segments are pre-matched to universal IDs gives buyers a turnkey cookieless targeting solution.',
    relationship_status: 'No Contact',
    data_richness: 8,
    icp: 5,
    founded_year: 2017,
  ...
  {
    id: 'orwell-research',
    name: 'Orwell Research',
    type: 'nogo',
    icp: 2,
    category: 'Market Research',
    hq_city: 'London',
    region: 'GB',
    website: 'https://orwellresearch.example',
    size: '1001-5000',
...
export const DEMO_CONTACTS = [
  {
    id: 'ct-by1',
    full_name: 'Keats Verlaine',
    title: 'Chief Revenue Officer',
    email: 'k.verlaine@byronics.example',
    company_name: 'Byronics',
    company_id: 'byronics',
  },
  {
    id: 'ct-by2',
    full_name: 'Sappho Kafka',
    title: 'VP Programmatic',
    email: 's.kafka@byronics.example',
    company_name: 'Byronics',
    company_id: 'byronics',
  },
  {
    id: 'ct-kf1',
    full_name: 'Tagore Brecht',
    title: 'CEO & Co-Founder',
    email: 't.brecht@kafkatech.example',
    company_name: 'Kafkatech',
    company_id: 'kafkatech',
  },
  {
    id: 'ct-kf2',
    full_name: 'Rilke Hugo',
    title: 'CPO & Co-Founder',
    email: 'r.hugo@kafkatech.example',
    company_name: 'Kafkatech',
    company_id: 'kafkatech',
  },
  {
    id: 'ct-vm1',
    full_name: 'Bashō Cervantes',
    title: 'Managing Director',
    email: 'b.cervantes@verlaine-media.example',
    company_name: 'Verlaine Media',
    company_id: 'verlaine-media',
  },
  {
    id: 'ct-ps1',
    full_name: 'Pessoa Ibsen',
    title: 'Head of Data & Monetisation',
    email: 'p.ibsen@pushkinstream.example',
    company_name: 'Pushkin Stream',
    company_id: 'pushkin-stream',
  },
  {
    id: 'ct-ds1',
    full_name: 'Akhmatova Dumas',
    title: 'VP EMEA Partnerships',
    email: 'a.dumas@dickenssupply.example',
    company_name: 'Dickens Supply',
    company_id: 'dickens-supply',
  },
  {
    id: 'ct-bi1',
    full_name: 'Rumi Chekhov',
    title: 'CEO & Co-Founder',
    email: 'r.chekhov@borgesidentity.example',
    company_name: 'Borges Identity',
    company_id: 'borges-identity',
  },
  {
    id: 'ct-bi2',
    full_name: 'Lorca Woolf',
    title: 'Director of Partnerships',
    email: 'l.woolf@borgesidentity.example',
    company_name: 'Borges Identity',
    company_id: 'borges-identity',
  },
];
...
export const DEMO_AUDIENCES = [
  {
    id: 'aud-demo-1',
    name: 'EU CTV Publishers Q2',
    description:
      'Connected TV and streaming publishers in Western Europe with first-party audience data and programmatic monetisation needs.',
    outreach_hook:
      'While EU publishers scramble to build cookieless alternatives, the real opportunity is simpler: activate the first-party CTV audiences they already have. onAudience segments plug directly into their existing DSP relationships — no SDK, no rebuild.',
  ...
  {
    id: 'aud-demo-2',
    name: 'Cookieless Identity Targets',
    description:
      'Identity and data infrastructure players positioned around the death of third-party cookies.',
    outreach_hook:
      "The cookie deprecation narrative is exhausted. But the buyers aren't. The real question for identity players is: whose audience segments will they activate once cookies are gone? onAudience is that answer.",
...
export const DEMO_RELATIONS = [
  {
    id: 'r1',
    from_company: 'kafkatech',
    to_company: 'addison-consent',
    relation_type: 'tech_integration',
    strength: 'confirmed',
    direction: 'bidirectional',
    notes: 'Kafkatech CDP integrates Addison Consent CMP for EU consent signal ingestion.',
  },
  {
    id: 'r2',
    from_company: 'verlaine-media',
    to_company: 'dickens-supply',
    relation_type: 'marketplace_listed',
    strength: 'confirmed',
    direction: 'unidirectional',
  },
  {
    id: 'r3',
    from_company: 'byronics',
    to_company: 'dickens-supply',
    relation_type: 'tech_integration',
    strength: 'strong',
    direction: 'unidirectional',
    notes: 'Byronics inventory available via Dickens Supply header bidding wrapper.',
  },
];
...
export function showDemoBanner() {
  ...
  document.getElementById('oa-demo-restart-btn')?.addEventListener('click', () => {
    ['oaTutorialDone', 'oaTutXP', 'oaAchievements', 'oaTutStep', 'oaTutLangs'].forEach((k) =>
...
export function patchNavForDemo() {
  ...
  const _patch = () => {
    ...
    if (nb && !nb.dataset.demo) {
      nb.innerHTML =
        '<span style="font-family:\'IBM Plex Mono\',monospace;font-size:8px;font-weight:600;color:#7A4200;background:#FEF2E0;border:1px solid rgba(122,66,0,.35);border-radius:2px;padding:2px 7px;letter-spacing:.06em;text-transform:uppercase;margin-right:4px;">DEMO</span>';
      nb.dataset.demo = '1';
    }
